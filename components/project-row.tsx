...
export function ProjectRow({
  ...
  return (
    <article aria-labelledby={headingId} className="mx-auto w-full max-w-[900px]">
      ...
      >
        {/* Project image */}
        <div className="group relative aspect-[600/429] w-full min-w-0 overflow-hidden rounded-[4px] bg-black md:w-[50%] md:shrink-0">
          <Image
            src={imageSrc}
            alt={title}
            fill
        ...
        <div className="flex min-w-0 flex-1 flex-col gap-2.5 text-black md:gap-3">
          ...
          {learned ? (
            <p className="font-cedarville text-[20px] font-normal leading-[1.3] text-text-primary">
              {learned}
            </p>
          ) : null}
